		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${requestScope.hotProducts}" var="hotProduct">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							...
							<p><a href="product_info.jsp" style='color:#666'>${hotProduct.pname}</a></p>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${requestScope.newProducts}" var="newProduct">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="product_info.jsp">
								<img src="${pageContext.request.contextPath}/${newProduct.pimage}" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="product_info.jsp" style='color:#666'>${newProduct.pname}</a></p>
