	...
	<div class="container" style="width: 100%; background: url('image/regist_bg.jpg');">
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form id="registForm" class="form-horizontal" action="${pageContext.request.contextPath}/userServlet?method=register" style="margin-top: 5px;" method="post">
					...
					<div class="form-group">
						<label for="telephone" class="col-sm-2 control-label">地址</label>
						<div class="col-sm-6">
